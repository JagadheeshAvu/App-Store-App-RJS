...
class AppStore extends Component {
  ...
  getActiveTabApps = searchedApps => {
    ...
    const filteredTabApps = searchedApps.filter(
      eachTab => eachTab.category === activeTabId,
    )
    return filteredTabApps
  }

  getUpdateSearchInput = () => {
  ...
  render() {
    ...
    const searchResults = this.getUpdateSearchInput()
    const filteredTabApps = this.getActiveTabApps(searchResults)
    return (
